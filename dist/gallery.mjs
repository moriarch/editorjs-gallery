...
class T {
  constructor({ api: r, config: a, onSelectFile: d, onDeleteFile: o, onMoveFile: i, readOnly: t }) {
    this.api = r, this.config = a, this.onSelectFile = d, this.onDeleteFile = o, this.onMoveFile = i, this.readOnly = t, this.nodes = {
  ...
  createFileButton() {
    ...
    return r.innerHTML = this.config.buttonContent || `${L} ${this.api.i18n.t("Select an Image")}`, r.addEventListener("click", () => this.onSelectFile()), r;
  }
  showFileButton() {
  ...
  getPreloader(r) {
    ...
    return d.readAsDataURL(r), d.onload = (o) => {
      a.style.backgroundImage = `url(${o.target.result})`;
    }, a;
  }
  removePreloader(r) {
    r.remove();
  ...
  appendImage(r) {
    let a = r.url;
    const d = /\.mp4$/.test(a) ? "VIDEO" : "IMG", o = { src: a };
    let i = "load";
    d === "VIDEO" && (o.autoplay = !1, o.muted = !0, o.playsinline = !0, i = "loadeddata");
    let t = C("div", [this.CSS.imageContainer]), c = C(d, this.CSS.imageEl, o);
    c.addEventListener(i, () => {
      this.toggleStatus(t, T.status.FILLED);
    }), t.appendChild(c);
    const g = C("input", [this.CSS.imageCaption], {
      placeholder: "Введите подпись к изображению",
      value: r.caption || "",
      disabled: this.readOnly
    });
    t.appendChild(g);
    const s = this.api.i18n.t("Delete");
    if (!this.readOnly) {
      let h = C("div", [this.CSS.trashButton], {
        innerHTML: I,
        title: s
      });
      this.api.tooltip.onHover(h, s, { placement: "top" }), h.addEventListener("click", () => {
        this.api.tooltip.hide();
        let y = Array.prototype.slice.call(this.nodes.itemsContainer.children).indexOf(t);
        y !== -1 && (this.nodes.itemsContainer.removeChild(t), this.onDeleteFile(y));
      }), t.appendChild(h);
    }
    this.nodes.itemsContainer.append(t);
  }
  fillCaption(r) {
    this.nodes.caption && (this.nodes.caption.value = r);
  }
  toggleStatus(r, a) {
    for (const d in T.status)
      r.classList.toggle(`${this.CSS.imageContainer}--${T.status[d]}`, a === T.status[d]);
  }
  updateLimitCounter(r, a) {
    a && this.nodes.limitCounter && (this.nodes.limitCounter.style.display = r === 0 ? "none" : null, this.nodes.limitCounter.innerText = `${r} / ${a}`);
  }
}
const C = function(r, a = null, d = {}) {
  const o = document.createElement(r);
  Array.isArray(a) ? o.classList.add(...a) : a && o.classList.add(a);
  for (const i in d)
    o[i] = d[i];
  return o;
...
class O {
   ...
   */
  constructor({ api: r, actions: a, onChange: d }) {
    this.api = r, this.actions = a, this.onChange = d, this.buttons = [];
  }
  /**
  ...
  (function(a, d) {
    ...
    return function(a) {
      ...
      function o(i) {
        ...
        return a[i].call(t.exports, t, t.exports, o), t.l = !0, t.exports;
      }
      return o.m = a, o.c = d, o.d = function(i, t, c) {
        o.o(i, t) || Object.defineProperty(i, t, { enumerable: !0, get: c });
      }, o.r = function(i) {
        ...
        if (o.r(c), Object.defineProperty(c, "default", { enumerable: !0, value: i }), 2 & t && typeof i != "string")
          for (var g in i)
            o.d(c, g, (function(s) {
              return i[s];
            }).bind(null, g));
      ...
      (function(i) {
          ...
          try {
            ...
            if (u && (typeof u == "object" || typeof u == "function")) {
              ...
              if (typeof l == "function")
                return void e((v = l, m = u, function() {
                  v.apply(m, arguments);
                }), n);
            }
        ...
        s.prototype.catch = function(n) {
          ...
          return new s(function(u, l) {
            ...
            var v = Array.prototype.slice.call(n);
            if (v.length === 0)
              return u([]);
            var m = v.length;
            function f(E, x) {
              try {
                if (x && (typeof x == "object" || typeof x == "function")) {
                  ...
                  if (typeof k == "function")
                    return void k.call(x, function(F) {
                      f(E, F);
                    }, l);
                }
                v[E] = x, --m == 0 && u(v);
      ...
      o(4);
      var t, c, g, s, h, p, y, b = o(8), w = (c = function(e) {
        return new Promise(function(n, u) {
          ...
          l.upload.addEventListener("progress", function(m) {
            var f = Math.round(m.loaded / m.total * 100), _ = Math.ceil(f * v / 100);
            e.progress(Math.min(_, 100));
          }, !1), l.addEventListener("progress", function(m) {
            var f = Math.round(m.loaded / m.total * 100), _ = Math.ceil(f * (100 - v) / 100) + v;
            e.progress(Math.min(_, 100));
      ...
      (function(i, t) {
        (function(c, g) {
          if (!c.setImmediate) {
            var s, h, p, y, b, w = 1, e = {}, n = !1, u = c.document, l = Object.getPrototypeOf && Object.getPrototypeOf(c);
            ...
            }() ? (y = "setImmediate$" + Math.random() + "$", b = function(f) {
              f.source === c && typeof f.data == "string" && f.data.indexOf(y) === 0 && m(+f.data.slice(y.length));
      ...
      function s(l) {
        ...
        if ((o === c || !o) && setTimeout)
          return o = setTimeout, setTimeout(l, 0);
        try {
          return o(l, 0);
        } catch {
          try {
            return o.call(null, l, 0);
          } catch {
      ...
      var h, p = [], y = !1, b = -1;
      function w() {
        y && h && (y = !1, h.length ? p = h.concat(p) : b = -1, p.length && e());
      }
      function e() {
        if (!y) {
          var l = s(w);
      ...
      t.nextTick = function(l) {
        ...
        if (arguments.length > 1)
          for (var m = 1; m < arguments.length; m++)
            v[m - 1] = arguments[m];
        p.push(new n(l, v)), p.length !== 1 || y || s(e);
      ...
      var o = function(t) {
        ...
        return c = c || null, g = g || "&", s = s || null, t ? function(h) {
          for (var p = new Array(), y = 0; y < h.length; y++)
            h[y] && p.push(h[y]);
          return p;
          ...
          if (s && (b = s + "[" + b + "]"), typeof t[h] == "object" && t[h] !== null)
            ...
            c && (y = b, b = !isNaN(parseFloat(y)) && isFinite(y) ? c + Number(b) : b);
            var w = t[h];
            w = (w = (w = (w = w === !0 ? "1" : w) === !1 ? "0" : w) === 0 ? "0" : w) || "", p = o(b) + "=" + o(w);
          }
          return p;
        })).join(g).replace(/[!'()*]/g, "") : "";
      };
...
class B {
   ...
   */
  uploadSelectedFiles(r, { onPreview: a, onUpload: d, onError: o }) {
    M.selectFiles({
      accept: this.config.types,
      multiple: !0
    }).then((i) => {
      let t = 0;
      for (var c = 0; c < i.length && !(r !== null && t == r); c++) {
        t++;
        let g = i[c], s = a(g), h;
  ...
  uploadByFile(r) {
    ...
    return a.append(this.config.field, r), this.config.additionalRequestData && Object.keys(this.config.additionalRequestData).length && Object.entries(this.config.additionalRequestData).forEach(([d, o]) => {
      a.append(d, o);
    }), M.post({
 ...
 * @author moriarch
 * @license MIT
 * @see {@link https://github.com/moriarch/editorjs-gallery} 
 */
class Z {
  ...
  constructor({ data: r, config: a, api: d, readOnly: o }) {
    ...
    }, this.uploader = new B({ config: this.config }), this.ui = new T({
      api: d,
      config: this.config,
      onSelectFile: () => {
        ...
        this.uploader.uploadSelectedFiles(i, {
          ...
          onUpload: (t, c) => this.onUpload(t, c),
          onError: (t, c) => this.uploadingFailed(t, c)
        });
      },
      onDeleteFile: (i) => this.deleteImage(i),
      onMoveFile: (i, t) => this.moveImage(i, t),
      readOnly: o
    }), this.tunes = new O({
      api: d,
  ...
  save() {
    ...
    return this._data.caption = r.value, this.ui.nodes.itemsContainer.querySelectorAll(`.${this.ui.CSS.imageContainer}`).forEach((d, o) => {
      const i = d.querySelector(`.${this.ui.CSS.imageCaption}`);
      i && this._data.files[o] && (this._data.files[o].caption = i.value);
    }), this.data;
  }
  renderSettings() {
  ...
  moveImage(r, a) {
    a >= this._data.files.length && (a = this._data.files.length - 1), this._data.files.splice(a, 0, this._data.files.splice(r, 1)[0]);
  }
  deleteImage(r) {
    this._data.files[r] !== void 0 && (this._data.files.splice(r, 1), this.checkMaxElemCount());
  }
  set data(r) {
    this._data.files = [], r.files && r.files.forEach((d) => this.appendImage(d)), this._data.caption = r.caption || "", this.ui.fillCaption(this._data.caption);
    let a = r.style || "";
    this.styleToggled(a);
  }
  get data() {
  ...
  onUpload(r, a) {
    this.ui.removePreloader(a), r.success && r.file ? this.appendImage(r.file) : this.uploadingFailed("incorrect response: " + JSON.stringify(r));
  }
  uploadingFailed(r, a) {
    this.ui.removePreloader(a), console.log("Image Tool: uploading failed because of", r), this.api.notifier.show({
      message: this.api.i18n.t("Couldn’t upload image. Please try another."),
      style: "error"
    });
  }
  styleToggled(r) {
    r === "fit" ? this._data.style = "fit" : this._data.style = "slider";
  }
  checkMaxElemCount() {
